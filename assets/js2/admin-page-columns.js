...
/*#__PURE__*/
function () {
  function AC_Column($el) {
    _classCallCheck(this, AC_Column);

    this.$el = $el;
    this._name = this.$el.data('column-name');
  }

  _createClass(AC_Column, [{
    key: "isOriginal",
    ...
    value: function initNewInstance() {
      ...
      var original_column_name = this.name; // update input names with clone ID
    ...
    value: function bindEvents() {
      ...
      this.$el.column_bind_events(); //this.$el.cpac_bind_ordering();
      ...
      var xhr = jQuery.ajax({
        ...
        success: function success(response) {
          if (true === response.success) {
            var test = jQuery(response.data);
            self.$el.replaceWith(test);
          }
        }
      });
      return this;
