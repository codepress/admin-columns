# Translation of Plugins - Admin Columns - Stable (latest release) in Polish
...
msgstr "Pełna dokumentacja, przesyłanie raportów błędów czy sugestii i porady użytkowania dostępne są na<a href='%s'>stronie Edytora kolumn</a>."
...
msgstr "Wartość: wartość szesnastkowa koloru, np. #808080."
...
msgstr "Wartość: może mieć formę tekstu bądź tablicy. Tablice zostaną spłaszczone, a wartości oddziela się przecinkami."
...
msgstr "Kolumna własnego pola wykorzystuje własne pola wpisów i użytkowników. Do wyboru dostępnych jest 14 typów danych."
...
msgstr "Ten tekst pojawi się przed wartością kolumny."
