...
class AC_Admin_Tab_Columns extends AC_Admin_TabAbstract {
	...
	private function display_column( CPAC_Column $column ) {
		...
		<div class="cpac-column column-<?php echo esc_attr( $column->get_type() ); ?>" data-type="<?php echo esc_attr( $column->get_type() ); ?>"<?php echo $column->get_property( 'is_cloneable' ) ? ' data-clone="' . esc_attr( $column->get_property( 'clone' ) ) . '"' : ''; ?> data-default="<?php echo esc_attr( $column->is_original() ); ?>">
