...
class Columns extends Admin\Page {
			...
			<div class="main">
				<div class="menu">
					<form>
						...
						<?php if ( $list_screen->get_screen_link() ) : ?>
							<a href="<?php echo esc_url( $list_screen->get_screen_link() ); ?>" class="page-title-action view-link"><?php esc_html_e( 'View', 'codepress-admin-columns' ); ?></a>
						<?php endif; ?>
					</form>
				</div>
	 ...
	 */
	public function register_help( WP_Screen $wp_screen ) {
