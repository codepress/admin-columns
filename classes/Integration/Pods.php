	...
	public function __construct() {
		parent::__construct(
			...
			sprintf(
				...
				sprintf( __( 'Display, inline- and bulk-edit, smart filter and sort your %s contents on any admin list table.', 'codepress-admin-columns' ), __( 'Pods', 'codepress-admin-columns' ) )
			),
			null,
