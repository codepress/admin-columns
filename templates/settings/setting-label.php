	...
	<tr>
		...
		<td class="col-input">
			<div class="ac-setting-input ac-setting-input-label">
				...
				<div class="acp-ipicker fixed" style="display: none;">
					<div class="acp-ipicker__modal">
						<?php
						$groups = array(
						...
						<div class="acp-ipicker__icons">
							<?php foreach ( $groups as $label => $icons ): ?>
								<h3 class="acp-ipicker__icons__group"><?php echo $label; ?></h3>
						...
						<div class="acp-ipicker__handles">
							<button class="button" data-action="submit">Select</button>
							<br>
							<a class="acp-ipicker__close" data-action="cancel">Cancel</a>
						</div>
					</div>
