...
<tr class="plugin-update-tr <?php echo esc_attr( implode( ' ', $this->status ) ); ?>" data-slug="<?php echo esc_attr( basename( $this->plugin_basename ) ); ?>" data-plugin="<?php echo esc_attr( $this->plugin_basename ); ?>">
