<template id="doc-filtering">
	...
	<p class="notice notice-warning">
        <?= sprintf(
            __('We recommend using %s', 'codepress-admin-columns'),
            sprintf('<strong>%s</strong>', __('Smart Filters', 'codepress-admin-columns'))
        ); ?>
	</p>
	<p>
        <?= sprintf(
            __('%s is an improved version of %s.', 'codepress-admin-columns'),
            sprintf('<em>%s</em>', __('Smart Filtering', 'codepress-admin-columns')),
            sprintf('<em>%s</em>', __('Filtering', 'codepress-admin-columns'))
        ); ?>
        <?= sprintf(
            __(
