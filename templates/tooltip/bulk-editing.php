...
<p>
	1. <?= __( 'Select more than one row from the list table to show the bulk edit buttons.', 'codepress-admin-columns' ); ?>
</p>
<img src="<?= esc_url( AC()->get_url() . 'assets/images/tooltip/bulk-edit.png' ); ?>" alt="Bulk Edit" style="border:1px solid #ddd;">
<p>
	2. <?= sprintf(
		__( 'Clicking the %s button will display a popup that allows you to add or change the current value of all selected items.', 'codepress-admin-columns' ),
