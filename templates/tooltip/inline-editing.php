...
<p>
	<?= sprintf( __( 'With Inline Edit, you can update your content quick and easy, without having to open each %s one at the time.', 'codepress-admin-columns' ), sprintf( '"%s"', $this->object_type ) ); ?>
</p>
<p>
...
<p>
	<a href="<?= esc_url( ac_get_site_documentation_url( \AC\Type\Url\Documentation::ARTICLE_INLINE_EDITING ) ); ?>" target="_blank">
