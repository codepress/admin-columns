<form method="post" id="frm-ac-restore">
	...
	<input type="submit" class="button" name="ac-restore-defaults" value="<?= esc_attr( __( 'Restore settings', 'codepress-admin-columns' ) ); ?>"
			sssonclick="return confirm('<?php echo esc_js( __( "Warning! ALL saved admin columns data will be deleted. This cannot be undone. 'OK' to delete, 'Cancel' to stop", 'codepress-admin-columns' ) ); ?>');">
</form>